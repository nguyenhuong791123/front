...
export default class CustomizeBox extends C {
    ...
    _onChange(e) {
        ...
        if(name === CUSTOMIZE.DEFAULT && (type === TYPE.FILE || type === TYPE.IMAGE)) {
          ...
          delete editBox.obj[OPTIONS_KEY.OPTION_LIST];
        ...
        if(Utils.isEmpty(editBox.obj[CUSTOMIZE.BOX_WIDTH])) {
          if(editBox.obj[CUSTOMIZE.TYPE] === TYPE.DIV) {
        ...
        return (
            <table className='table-overlay-box'>
                ...
                {(() => {
                    if (obj === null 
                        ...
                        return(
                            <tr>
                            {(() => {
                                if (editBox[CUSTOMIZE.TYPE] !== TYPE.PASSWORD && editBox[CUSTOMIZE.TYPE] !== TYPE.BUTTON) {
                                return(
                                    <td className='td-not-break'>
                                        { Msg.getMsg(null, this.state.isUser.language, 'obj_default') }
                                        {(() => {
                                            if (editBox[CUSTOMIZE.TYPE] === TYPE.IMAGE || editBox[CUSTOMIZE.TYPE] === TYPE.DISABLE) {
                    ...
                    return(
                        ...
                        {(() => {
                            ...
                            return(
                                <td className='td-not-break'>
                                {(() => {
                                    if (editBox[CUSTOMIZE.TYPE] === TYPE.FILE || editBox[CUSTOMIZE.TYPE] === TYPE.IMAGE) {
                                        return('MaxSize(MB)');
                                    } else {
                                        return('MaxLength');
                                    }
                    ...
                    return(
                        ...
                        <td>
                            <FormControl
                                ...
                                defaultValue={ editBox[OPTIONS_KEY.OPTION_LIST] }
                                onChange={ this._onChange.bind(this) }>
                                { this.state.options }
                            </FormControl>
                        </td>
                ...
                {(() => {
                    ...
                    && editBox[CUSTOMIZE.TYPE] !== TYPE.DIV
                    && editBox[CUSTOMIZE.TYPE] !== TYPE.TAB
                    && Utils.isEmpty(editBox[OPTIONS_KEY.OPTION_LIST])) {
                    return(
                        <tr>
                            <td colSpan='4'>
